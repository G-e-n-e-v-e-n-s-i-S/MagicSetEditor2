...
static bool check_table_headers(GameP& game, std::vector<String>& headers, const String& file_extension, String& missing_fields_out) {
  ...
  for (int x = 0; x < headers.size(); ++x) {
    ...
    String unified_key_name = unified_form(key_name);
    if ( game->card_fields_alt_names.find(unified_key_name) == game->card_fields_alt_names.end()
      || unified_key_name == _("notes")
      || unified_key_name == _("note")
      || unified_key_name == _("style")
      || unified_key_name == _("stylesheet")
      || unified_key_name == _("template")
      || unified_key_name == _("id")
      || unified_key_name == _("uid")
      || unified_key_name == _("multiverse_id")
      || unified_key_name == _("linked_card")
      || unified_key_name == _("linked_card_1")
      || unified_key_name == _("linked_card_2")
      || unified_key_name == _("linked_card_3")
      || unified_key_name == _("linked_card_4")
      || unified_key_name == _("linked_relation")
      || unified_key_name == _("linked_relation_1")
      || unified_key_name == _("linked_relation_2")
      || unified_key_name == _("linked_relation_3")
      || unified_key_name == _("linked_relation_4")
      || unified_key_name == _("link_relation")
      || unified_key_name == _("link_relation_1")
      || unified_key_name == _("link_relation_2")
      || unified_key_name == _("link_relation_3")
      || unified_key_name == _("link_relation_4")
    ) {
